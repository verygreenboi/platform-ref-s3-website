...
${KUBECTL} wait configuration.pkg platform-ref-s3-website --for=condition=Installed --timeout 5m
echo "Waiting until configuration package is healthy..."
${KUBECTL} wait configuration.pkg platform-ref-s3-website --for=condition=Healthy --timeout 5m
...
${KUBECTL} create namespace demo-website
